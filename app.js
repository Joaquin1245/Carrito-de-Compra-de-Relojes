...
var carritoVisible = false;
 ...
 function ready() {
    ...
    function agregarAlCarritoClicked(event) {
        ...
        // La siguiente función agrega el elemento al carrito. Le mando por parámetros los valores
    ...
    function pagarClicked(event) {
        ...
        // Elimino todos los ementos del carrito
        var carritoItems = document.getElementsByClassName("carrito-items")[0];
    ...
    function hacerVisibleCarrito(){
        ...
        var items = document.getElementsByClass("contenedor-items")[0];
